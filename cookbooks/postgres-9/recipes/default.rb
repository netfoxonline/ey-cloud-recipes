...
if node[:instance_role] == 'db_master'
  ...
  remote_file "/var/lib/postgresql/9.0/data/postgresql.conf" do
  ...
  template "/var/lib/postgresql/9.0/data/pg_hba.conf" do
    owner 'postgres'
    group 'root'
    mode 0600
  ...
  execute "restart-postgres" do
    ...
    action :run
    not_if "/etc/init.d/postgresql-9.0 status | grep -q start"
  end
